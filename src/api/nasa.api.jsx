...
export const getDailyPhotoData = axios.create({ baseURL: `https://api.nasa.gov/planetary/apod?api_key=${env.VITE_NASA_API_KEY}`, });
export const getMarsWeatherData = axios.create({ baseURL: `https://api.nasa.gov/insight_weather/?feedtype=json&ver=1.0&api_key=${env.VITE_NASA_API_KEY}`, });
